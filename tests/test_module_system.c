...
void test_import_val_declarations(void) {
    ...
    const char* code = "import declarations.{CONSTANT_VALUE}\n"
                       "CONSTANT_VALUE";
...
void test_import_var_declarations(void) {
    ...
    const char* code = "import declarations.{mutable_counter}\n"
                       "mutable_counter";
...
void test_import_def_declarations(void) {
    ...
    const char* code = "import declarations.{square}\n"
                       "square(5)";
...
void test_import_data_declarations(void) {
    ...
    const char* code = "import declarations.{Point}\n"
                       "Point(3, 4)";
...
void test_wildcard_import(void) {
    const char* code = "import declarations._\n"
...
void test_selective_import(void) {
    const char* code = "import declarations.{CONSTANT_VALUE, add, PI}\n"
...
void test_renamed_import(void) {
    const char* code = "import declarations.{CONSTANT_VALUE => const_val, square => sq}\n"
                       "sq(const_val)";
...
void test_public_from_mixed_module(void) {
    const char* code = "import private_mixed.{PUBLIC_CONST, public_function}\n"
...
void test_data_constructor_variations(void) {
    ...
    const char* code = "import datatypes.{Empty, Color, Name}\n"
...
void test_function_composition_across_modules(void) {
    const char* code = "import functions.{compose, multiply, add}\n"
...
void test_mixed_declaration_import(void) {
    const char* code = "import declarations.{CONSTANT_VALUE, square, Point, Success}\n"
...
void test_immutable_module_constants(void) {
    const char* code = "import immutable.{NUMBER_CONST, COMPUTED, DERIVED}\n"
...
void test_functions_with_imported_data(void) {
    const char* code = "import functions.{maximum}\n"
...
void test_module_namespace_access(void) {
    ...
    const char* factorial_code = "import recursive_math\n"
    ...
    const char* gcd_code = "import recursive_math\n"
    ...
    const char* fib_code = "import recursive_math\n"
    ...
    const char* mixed_code = "import recursive_math\n"
...
void test_deep_nested_namespace_import(void) {
    ...
    const char* code = "import submodules.deeply_nested\n"
    ...
    const char* const_code = "import submodules.deeply_nested\n"
    ...
    const char* constant_code = "import examples.modules.math.advanced\n"
                                "advanced.PI";
...
void test_single_item_import(void) {
    ...
    const char* factorial_code = "import recursive_math.factorial\n"
                                 "factorial(4)";
    ...
    const char* gcd_code = "import recursive_math.gcd\n"
                           "gcd(15, 25)";
    ...
    const char* const_code = "import declarations.PI\n"
                             "PI";
    ...
    const char* mixed_code = "import recursive_math.factorial\n"
