...
\ Import specific functions from the math package files
import examples.modules.math.basic.{add, multiply}
import examples.modules.math.constants.{PI}

\ Import everything from utils
import examples.modules.utils._

\ Import with renaming from advanced math
import examples.modules.math.advanced.{factorial => fact, isPrime => prime}
